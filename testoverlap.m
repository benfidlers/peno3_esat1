...
function [row_start, row_stop, col_start, col_stop]= depth_to_color(pipemm_depth_H , pipemm_depth_W , pipemm_color_H , pipemm_color_W,row, col,size,nb_rows_color , nb_columns_color,nb_rows_depth, nb_columns_depth)
