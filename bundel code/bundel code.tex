...
\lstinputlisting{initialisation_gui.m}
\subsection{Opening function}
\lstinputlisting{opening_function.m}
\subsection{Output function}
\lstinputlisting{output_function.m}
\subsection{Interactive buttons}
\subsubsection{Start button}
\lstinputlisting{startbutton.m}
\subsubsection{Original image}
\lstinputlisting{original.m}
\subsubsection{Image after Sobel operator}
\lstinputlisting{sobel_callback.m}
\subsubsection{Red box callback}
\lstinputlisting{redbox_callback.m}
\subsubsection{Image after the crop to basket}
\lstinputlisting{crop_callback.m}
\subsubsection{Edge matrix}
\lstinputlisting{edge_callback.m}
\subsubsection{Image of grouped objects}
\lstinputlisting{grouped_callback.m}
\subsubsection{Image of regrouped objects}
\lstinputlisting{regrouped_callback.m}
\subsubsection{The final result}
\lstinputlisting{result_callback.m}
