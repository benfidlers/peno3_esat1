...
[updated_corner_points, nb_of_groups3] = remove_box_edge(corner_points, nb_of_groups2); % Remove the boundary box of the box.
[updated_corner_points, nb_of_groups3] = remove_corner_points_within_corner_points(updated_corner_points, nb_of_groups3); % Remove boundary boxes fully inside other boundary boxes.
