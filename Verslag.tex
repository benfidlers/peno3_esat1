...
As seen above, the system explained in this paper consist primarily of software which in itself don't cost anything. The hardware component on the other hand is a cost and a significant one. The current set-up consists of a tripod and the electronics. The tripod is lend for free by the faculty thus the only cost remains the kinect 2 and it's adapter to computer.
