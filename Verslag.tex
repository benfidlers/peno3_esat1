...
\includepdf[pages=1,scale=.8,pagecommand={\section*{Diagram}\label{pdf:work_plan}},linktodoc=true]{work_plan.pdf}

\newpage
\includepdf[scale=.8,pagecommand={\section*{Gantt chart}\label{pdf:Automatic}},linktodoc=true]{Automatic.pdf}}
